...
class MCPConfigGenerator:
    ...
    def generate_mcp_json(self, yml_file: str, server_path: str = None, 
        ...
        try:
            ...
            template = self.jinja_env.get_template('mcp_config.json.j2')
            ...
            raise RuntimeError(f"Failed to generate MCP configuration: {e}")