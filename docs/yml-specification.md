...
### Resources
Resources are static data that clients can read. They are generated by shell commands and can be parameterized using arguments.
...
### Prompts
Prompts are dynamic templates that clients can use to generate content. They support Jinja2 templating for flexible prompt generation.
